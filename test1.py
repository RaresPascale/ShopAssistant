...
# Function to open and display the data in the text file
def open_txt():
    global file_path
...
#my_text = Label(root, text="Lista de Cumparaturi",font=("Helvetica", 40), bg="#c46b46")
#my_text.pack(pady=100)


#Frame-ul pentru tabel

table_frame = Frame(root)
table_frame.pack(pady=200)


# Treeview widget inside the frame
